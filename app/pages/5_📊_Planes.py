...
with tab_cronogramas:
    ...
    st.info(
        ...
        "**\U0001f4c5 Cronogramas \u2192 Validar**, donde queda registrada en "
        "el historial. Esta pagina la sigue mostrando para mantener el flujo "
        "de ajuste fino de comisiones por materia."
    )
